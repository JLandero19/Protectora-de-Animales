...
class PublicationModel {
    ...
    public static function mdlAll($table) {
        $sql = Connect::connected()->prepare("SELECT * FROM $table ORDER BY creation_date DESC");
        $sql->execute();
        $query = $sql->fetchAll();
    ...
    public static function mdlLastID($table) {
        $str = "SELECT * FROM $table ORDER BY id DESC LIMIT 1";
    ...
    public static function mdlRecentBlog($table, $num) {
        $str = " SELECT * FROM $table ORDER BY creation_date DESC LIMIT $num ";
        $sql = Connect::connected()->prepare($str);
        $sql->execute();
        $query = $sql->fetchAll();
    ...
    public static function mdlGalleryPreview($table, $num) {
        $str = " SELECT * FROM $table ORDER BY id DESC LIMIT $num ";
        $sql = Connect::connected()->prepare($str);
        $sql->execute();
        $query = $sql->fetchAll();
    ...
    public static function mdlAllGallery($table) {
