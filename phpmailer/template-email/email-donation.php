...
<p style="margin: 0;">Gracias por tu aportación, es para una buena causa, como es cuidar a los animales abandonados. Ellos también te lo agradecen.</p>
<p style="margin: 0;">
    <b>Email:</b> <?= $mail_to ?> <br />
    <b>Orden ID:</b> <?= $order_id ?> <br />
    <b>Importe:</b> <?= $donation ?> €
</p>
</div>
</td>
</tr>
