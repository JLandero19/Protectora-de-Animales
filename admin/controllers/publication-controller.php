...
class PublicationController {
        ...
        if ($message == "") {
            ...
            if ($message == "") {
                ...
                if ($query == true) {
                    ...
                    return "<script type='text/javascript'>alert('Se ha añadido una nueva publicación.');window.location = 'blog';</script>";
        ...
        if ($message == "") {
            ...
            if (isset($_FILES['image']['tmp_name']) && $_FILES['image']['tmp_name'] != null) {
                ...
                if ($message == "") {
                    ...
                    if (move_uploaded_file($_FILES['image']['tmp_name'], $route)) {
                        //Cambiamos los permisos del archivo a 777 para poder modificarlo posteriormente
                        chmod($route, 0777);
                        // if ($_POST['image_original'] != NULL) {
                        //     unlink("../views/images/publications/".$_POST['image_original']);
                        // }
            ...
            if ($message == "") {
                ...
                if ($query == true) {
                    ...
                    return "<script type='text/javascript'>alert('Se ha actualizado una publicación.');window.location = 'blog';</script>";
                }
            }
        }
    ...
    public function ctrDeleteItem($table, $id) {
        ...
        if ($query == true) {
            return "<script type='text/javascript'>alert('Se ha eliminado publicación " . $search['title'] . "');</script>";
            // return "<div class='alert alert-info mt-2' role='alert'>Se ha eliminado publicación " . $search['title'] . ".</div>";
        } else {
            return "<script type='text/javascript'>alert('Ha habido un error al eliminar la publicación " . $search['title'] . "');</script>";
            // return "<div class='alert alert-danger mt-2' role='alert'>Ha habido un error al eliminar la publicación " . $search['title'] . ".</div>";
        }
    }
}
?>
