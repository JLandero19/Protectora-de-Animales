...
class UserModel {
    ...
    public static function mdlWhereNotAdmin($table) {
        $query = " SELECT * FROM $table ";
    ...
    public static function mdlSearchUser($field, $value) {
        $query = " SELECT * FROM roles r JOIN users u ON r.id = u.role_id ";
    ...
    // Insertar cualquier cosa en una sola tabla
